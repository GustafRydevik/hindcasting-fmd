...
This section describes an analysis of data collected on FMD prevalence in a dataset of 1500 cattle distributed across XX herds. The goal of the data collection was to get information on the time since last FMD incursion in a herd. Various aspects of the dataset has been described and analyzed in a number of publications [1,2,3,...]. Here, we will describe how the prevalence data can be transformed to provide information on disease incidence. 
